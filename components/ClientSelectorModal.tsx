        ...
        <div className="p-6 border-b border-surface-border bg-surface-raised/50">
          ...
          <div className="relative w-full">
            ...
            <input
              ...
              className="w-full h-11 bg-white rounded-lg pl-11 pr-4 text-sm font-medium text-primary placeholder:text-muted focus:outline-none focus:border focus:border-brand shadow-sm border border-surface-border transition-all"
            />
          </div>
        </div>
          ...
          <div className="space-y-2">
            {filteredClients.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-12 text-center">
                ...
                <p className="text-sm font-bold text-primary mb-1">No matching clients</p>
                <p className="text-xs font-medium text-muted mb-4 max-w-[200px]">
                  We couldn&apos;t find anyone in your directory matching &quot;{search}&quot;.
                </p>
              ...
              filteredClients.map((client) => (
                ...
                >
                  ...
                  <div className="w-8 h-8 rounded-full border border-surface-border bg-white flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                    <ChevronRight size={14} className="text-brand" strokeWidth={2.5} />
                  </div>
                </button>
              ))
            )}
